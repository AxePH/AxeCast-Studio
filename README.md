...
| 🤖 **Android APK** | [`AxeCast-Stream-v1.0.4.apk`](https://github.com/AxePH/AxeCast-Studio/releases/latest) | Install on Android for wireless & remote streaming |
| 🍏 **iOS IPA** | [`AxeCast-Stream-v1.0.4.ipa`](https://github.com/AxePH/AxeCast-Studio/releases/latest) | Install on iPhone / iPad for ReplayKit streaming |
